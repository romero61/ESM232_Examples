...
best_parameter <- res %>% slice_max(combined_metric) |> mutate(parameter_type = 'best', .before = sim)
worst_parameter <- res %>% slice_min(combined_metric) |> mutate(parameter_type = 'worst', .before = sim)
